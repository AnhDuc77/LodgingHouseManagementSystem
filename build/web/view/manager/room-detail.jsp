    ...
    <head>
        ...
        <style>
            ...
            .image-container {
                display: flex;
                flex-wrap: wrap;
                gap: 10px; /* Điều chỉnh khoảng cách giữa các hình ảnh */
            }

            .image-wrapper {
                flex: 0 1 calc(50% - 10px); /* Đặt chiều rộng của mỗi hình ảnh chiếm 50% của hàng, trừ đi khoảng cách giữa các hình ảnh */
                box-sizing: border-box; /* Đảm bảo padding và border được bao gồm trong chiều rộng và chiều cao */
            }

            .fixed-size-image {
                width: 100%; /* Đặt hình ảnh để chiếm toàn bộ chiều rộng của wrapper */
            ...
            <main class="app-content">
                <div class="app-title">
                    <ul class="app-breadcrumb breadcrumb side">
                        <li class="breadcrumb-item"><a href="/ManageLodgingHouse/home-manager"><b>Quản lí trọ</b></a></li>
                        <li class="breadcrumb-item active"><a href="room-detail-servlet?id=${sessionScope.roomId}"><b>Chi tiết phòng</b></a></li>
                    </ul>
                    <div id="clock"></div>
                </div>
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="image-container">
                                    <c:if test="${room.image != null}">
                                        <div class="image-wrapper"><img class="fixed-size-image" src="${room.image}" alt="Hình ảnh đã bị lỗi!"/></div>
                                        </c:if>
                                        <c:if test="${room.getImage2() != null}">
                                        <div class="image-wrapper"><img class="fixed-size-image" src="${room.getImage2()}" alt="Hình ảnh đã bị lỗi!"/></div>
                                        </c:if>
                                        <c:if test="${room.image3 != null}">
                                        <div class="image-wrapper"><img class="fixed-size-image" src="${room.image3}" alt="Hình ảnh đã bị lỗi!"/></div>
                                        </c:if>
                                        <c:if test="${room.image4 != null}">
                                        <div class="image-wrapper"><img class="fixed-size-image" src="${room.image4}" alt="Hình ảnh đã bị lỗi!"/></div>
                                        </c:if>
                                </div>
