        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"> <a href="/ManageLodgingHouse/home-manager?LodgingHouseID=3">Quản các phòng trọ</a></li>
                        ...
                        <div class="tile-body">
                            <form class="row" action="add-room-servlet" method="post" id="form-1">
                                <div class="form-group col-md-6">
                                    ...
                                    <div id="errorMessageName" data-error-message="Nhập đúng theo quy tắc (Không để toàn khoảng trắng, phần từ đầu và cuối không là khoảng trắng, giữa 2 chữ không có nhiều hơn 1 khoảng trắng, không có kí tự đặc biệt...)"  class="hidden"></div>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="roomStatus" name="roomStatus">
                                        ...
                                        <option value="3">Tạm ngưng cho thuê</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
...
<<<<<<< HEAD
                                ...
                                <div class="form-group col-md-6">
=======
>>>>>>> 4beecd60c46f3f0f18475286f39feb57fcb21de6
                                ...
                                <div class="form-group col-md-3">
                                    <label for="imageUpload">Tải ảnh 1 lên</label>
                                    <progress value="0" max="100" id="uploader">0%</progress>
                                    <input type="file" value="upload" accept=".jpg" id="fileButton">
                                    <input name="avatar" type="text" id="avatar" style="display: none">
                                    <div id="imgDiv"></div>                                       
                                ...
                                <div class="form-group col-md-3">
                                    <label for="imageUpload">Tải ảnh 2 lên</label>
                                    <progress value="0" max="100" id="uploader2">0%</progress>
                                    <input type="file" value="upload" accept=".jpg" id="fileButton2">
                                    <input name="avatar2" type="text" id="avatar2" style="display: none">
                                    <div id="imgDiv2"></div>                                       
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="imageUpload">Tải ảnh 3 lên</label>
                                    <progress value="0" max="100" id="uploader3">0%</progress>
                                    <input type="file" value="upload" accept=".jpg" id="fileButton3">
                                    <input name="avatar3" type="text" id="avatar3" style="display: none">
                                    <div id="imgDiv3"></div>                                       
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="imageUpload">Tải ảnh 4 lên</label>
                                    <progress value="0" max="100" id="uploader4">0%</progress>
                                    <input type="file" value="upload" accept=".jpg" id="fileButton4">
                                    <input name="avatar4" type="text" id="avatar4" style="display: none">
                                    <div id="imgDiv4"></div>                                       
                                </div>
...
=======
                ...
                var nameOfRoom = '<%= request.getAttribute("listOfRoomName")%>';
                var nameArray = JSON.parse(nameOfRoom);
                ...
                for (let i = 0; i < nameArray.length; i++) {
                    ...
                    if (nameArray[i].trim().toLowerCase() === inputValue.trim().toLowerCase()) {
                        isDuplicate = true;
                        return false;
                    } else {
                        isDuplicate = false;
                ...
                if (inputField) {
                    if (!isValidField) {
                        ...
                        if (isDuplicate == false) {
                            ...
                            errorMessage.textContent = 'Tên này đã tồn tại';
                        }
...
=======
                        ...
                        function uploadImage(uploaderId, fileButtonId, avatarId, imgDivId) {
...
// Gọi hàm cho từng bộ tải ảnh
                        uploadImage('uploader', 'fileButton', 'avatar', 'imgDiv');
                        uploadImage('uploader2', 'fileButton2', 'avatar2', 'imgDiv2');
                        uploadImage('uploader3', 'fileButton3', 'avatar3', 'imgDiv3');
                        uploadImage('uploader4', 'fileButton4', 'avatar4', 'imgDiv4');
