                        ...
                        <div class="tile-body">
                            <form class="row" action="update-room-servlet" method="post" id="form">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="number" min="0" placeholder="Số người ở tối đa" name="maxOfQuantity" value="${requestScope.room.getMaxOfQuantity()}" required>                               
                                </div>

                                <div class="form-group col-md-6">
                                    <label class="control-label">Trạng thái phòng</label>
                                    <select class="form-control" id="roomStatus" name="roomStatus">
                                        <c:if test="${requestScope.room.getStatus() == 0}">
                                            <option value="0">Còn trống</option>
                                            <option value="3">Tạm ngưng cho thuê</option>
                                        </c:if>
                                        <c:if test="${requestScope.room.getStatus() == 3}">
                                            <option value="3">Tạm ngưng cho thuê</option>
                                            <option value="0">Còn trống</option>
                                        </c:if>
                                    </select>                               
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <button class="btn btn-cancel" type="reset" style="margin-right: 10px">Hủy</button>
                                </div>
                                <div class="form-group col-md-6">
