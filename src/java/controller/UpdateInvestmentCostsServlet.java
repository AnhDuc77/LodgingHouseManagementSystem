...
public class UpdateInvestmentCostsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("manager", informationOfUser.getFullName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("price: " + priceRaw);
        ...
        try {
            ...
            InvestmentCost newInvestmentCost = new InvestmentCost(price,
                    ...
                    1,
                    2);
            System.out.println("Type kkkk" + newInvestmentCost.getTypeAccept());
