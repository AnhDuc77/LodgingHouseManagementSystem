...
public class BillDAO extends DBContext {
    ...
    public int sumDebt(int year, int month, int lodgingHouseId) {
        String sql = "SELECT SUM(Missing) AS money FROM Bill B FULL JOIN Rooms R ON R.RoomId = B.RoomId WHERE YEAR(MonthYear) = ? AND MONTH(MonthYear) = ?";
        if (lodgingHouseId != 0) {
            sql += " AND R.LodgingHouseId = ?";
        }
...
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(a.sumDebt(2024, 1, 2));
    }
}
