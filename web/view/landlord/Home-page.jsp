...
=======
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a class="app-menu__item" id="menu-item" href="quan-ly-bao-cao.html">
                        <i class='app-menu__icon bx bx-pie-chart-alt-2'></i>
                        <span class="app-menu__label">Báo cáo doanh thu</span>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="report-on-debt" style="color:white">Báo cáo công nợ</a></li>
                        <li><a href="report-rental-status" style="color:white">Báo cáo tình trạng thuê phòng</a></li>
