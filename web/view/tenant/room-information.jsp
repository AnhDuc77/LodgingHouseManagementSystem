                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="row element-button">
                                        <div class="col-sm-4">
                                            <a class="btn btn-delete btn-lg btn-block nhap-tu-file" href="home-tenant?service=showLodgingInfor">
                                                <i class="fas fa-file-upload"></i>Trở Về
                                            </a>
                                        </div>
                                        <div class="col-sm-4">
                                ...
                                <c:if test="${sessionScope.account.getRoleId() == 3}">
                                    <c:set value="${requestScope.roomByID}" var="room"/>
                                        ...
                                        <a class="btn btn-delete btn-lg btn-block nhap-tu-file" href="add-roommate?roomID=${room.getRoomId()}" title="Thêm nhân viên"><i class="fas fa-plus"></i>
                                            Thêm bạn cùng phòng</a>
